...
loaded_checkpoint = ModelHelper.load_checkpoint(check_point_file)

# Build the model with check point
model_helper = ModelHelper(loaded_checkpoint['arch'], loaded_checkpoint['hidden_units'])
...
predict_image = PredictImage(preprocessed_image, model_helper.get_model(), args.topk, args.gpu)
...
predict_image.display_predicted_image(cat_to_name)